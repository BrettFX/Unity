...
{
    public class BabertPlayerHealth : MonoBehaviour
    {
        static BabertPlayerHealth instance;
        public static BabertPlayerHealth Instance { get { return instance; } }
        ...
        void Awake()
        {
            ...
            instance = GetComponent<BabertPlayerHealth>();
        }
